...
| 4 (CE40𝓵AL, CE20𝓵AL, LI) | 6b (CE40𝓵AL, ET-D, LI) | 9ab (LH, LL, LI) at A+ and A# sensitivity
...
|------------------|---------------------|---------|----------|------------|------------|--------------------|
| **Spin model** | Isotropically oriented and uniform magnitude [0,1] | Non-spin | BH spin is Gaussian with mean 0 and std dev 0.2 BN spins uniform ~ [0.1, 0.1] | Isotropically oriented and uniform magnitude [0,1] | Isotropically oriented and uniform magnitude [0,1] | Isotropically oriented and uniform magnitude [0,1] |
