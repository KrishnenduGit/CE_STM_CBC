...
for cbc_type in ['BBH', 'NSBH', 'BNS']:
    if n_samples_cbc[cbc_type]//1e6 != 0:
        n_samples_strs[cbc_type] = str(round(n_samples_cbc[cbc_type]/1e6, 1))+'M'
    elif n_samples_cbc[cbc_type]//1000 != 0:
        n_samples_strs[cbc_type] = str(round(n_samples_cbc[cbc_type]/1000))+'K'
    else:
